...
个人多功能空间：课表、资金规划、统一设置。当前前端版本 v3.6。
...
- `index.html`：前端结构、交互和20门次离线兜底课表（个人课表18门次、1门李娜带教课程，以及9月14日用户确认新增的《现代灌排理论与新技术（学硕）》）。新增课程为周二3–5节、第3–13周、周立峰、农工楼412；保留原专硕课程，不将两者合并。
